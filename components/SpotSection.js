...
export default ({ items }) => {
    return (
        <section className=" relative p-2 md:p-4">
            <div className="flex flex-row text-blue-500 text-sm items-center space-x-2 md:text-lg lg:text-xl border-b-[1px] md:p-3">
                <i className="twicon-queens-head text-xl  md:text-2xl lg:text-4xl "></i>
                <span>景點</span>
            </div>
